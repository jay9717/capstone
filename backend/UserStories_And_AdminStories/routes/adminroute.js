...
adminrouter.get("/home",admin.product_user)              // to get all userdetails and productdetails by admin
adminrouter.post("/createproduct",admin.createbook)      // for creating products by admin
adminrouter.put("/updateproduct/:id",admin.updatebook)       // for update quantity by admin
adminrouter.delete("/deleteproduct/:id",admin.deletebook) // for delete product by admin through id
